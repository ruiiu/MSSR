...
def get_cosine_schedule_with_warmup(
    ...
    """Get the lr scheduler for cosine annealing with optional warmup."""
    from torch.optim.lr_scheduler import CosineAnnealingLR, LinearLR, SequentialLR

    # If no warmup, return pure cosine annealing
    ...
    # Cosine annealing phase: cosine decay from base_lr to min_lr
...
def get_linear_schedule_with_warmup(
    ...
    """Get the lr scheduler for linear decay with optional warmup."""
    from torch.optim.lr_scheduler import LinearLR, SequentialLR

    # If no warmup, return pure linear decay
    if num_warmup_steps == 0:
        return LinearLR(
            optimizer,
            start_factor=1.0,
    ...
    # Linear decay phase: linear decrease from base_lr to min_lr
    ...
    # Combine warmup and linear decay
    return SequentialLR(
        optimizer,
