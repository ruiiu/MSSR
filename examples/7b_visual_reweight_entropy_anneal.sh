...
python3 -m verl.trainer.main \
    ...
    algorithm.mvsr_enable_visual_reweighting=true \
    algorithm.use_entropy_shaping=true \
    algorithm.mvsr_visual_annealing=true \
    algorithm.mvsr_visual_annealing_start_prob=1.0 \
    algorithm.mvsr_visual_annealing_end_prob=0.0 \
    algorithm.mvsr_visual_annealing_start_step=0 \
