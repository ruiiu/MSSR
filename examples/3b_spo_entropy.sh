...
MODEL_PATH=Qwen/Qwen2.5-VL-3B-Instruct  # Must be a multimodal model
...
#     -- \
    ...
    trainer.experiment_name=3b_spo_entropy_vision \
    trainer.n_gpus_per_node=$RAY_GPU_COUNT \
    trainer.load_checkpoint_path=checkpoints/mm-spo/3b_spo_entropy_vision/global_step_100 \
